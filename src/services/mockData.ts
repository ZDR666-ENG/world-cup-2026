...
export const mockNews: News[] = [
  { id: 1, title: '梅西宣布最后一届世界杯：这是我的告别演出', description: '阿根廷球星梅西确认2026年世界杯将是他职业生涯的最后一届世界杯，他希望用一座冠军奖杯为自己的国家队生涯画上完美句号。', content: '', imageUrl: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=800', publishedAt: new Date().toISOString(), source: 'FIFA官方', url: 'https://www.fifa.com' },
  { id: 2, title: '姆巴佩vs哈兰德：新一代球王之争', description: '法国巨星姆巴佩与挪威杀手哈兰德的对决已成为当今足坛最热门的话题，两人在世界杯赛场上的表现将决定谁是下一代球王。', content: '', imageUrl: 'https://images.unsplash.com/photo-1431324155629-1a6deb1dec8d?w=800', publishedAt: new Date(Date.now() - 86400000).toISOString(), source: '体育新闻', url: 'https://www.sports.com' },
  { id: 3, title: '巴西新10号维尼修斯：桑巴足球的未来', description: '维尼修斯在本届世界杯上展现出惊人的状态，他的速度和突破让对手防不胜防，被誉为内马尔接班人。', content: '', imageUrl: 'https://images.unsplash.com/photo-1522778119026-d647f0596c20?w=800', publishedAt: new Date(Date.now() - 172800000).toISOString(), source: 'FIFA官方', url: 'https://www.fifa.com' },
  { id: 4, title: '亚洲足球崛起：日本韩国创造历史', description: '日本和韩国在本届世界杯上表现出色，多场胜利让亚洲足球在世界舞台上闪耀，证明亚洲足球已经达到世界顶级水平。', content: '', imageUrl: 'https://images.unsplash.com/photo-1551958219-acbc608c6377?w=800', publishedAt: new Date(Date.now() - 259200000).toISOString(), source: '足球周刊', url: 'https://www.footballweekly.com' },
  { id: 5, title: '世界杯进球集锦：十大精彩进球', description: '本届世界杯已诞生多个精彩进球，从远射到任意球，从头球到倒钩，每个进球都让球迷热血沸腾。', content: '', imageUrl: 'https://images.unsplash.com/photo-1579952363873-27f3bade9f55?w=800', publishedAt: new Date(Date.now() - 345600000).toISOString(), source: '体育新闻', url: 'https://www.sports.com' },
];