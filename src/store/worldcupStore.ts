...
export const useWorldCupStore = create<WorldCupState>((set) => ({
  ...
  fetchStandings: async () => {
    ...
    try {
      ...
      set({ 
        error: error instanceof Error ? error.message : '获取积分榜失败',
        loading: false 
      });
    }
  },
  ...
  fetchTeams: async () => {
    ...
    try {
      ...
      set({ 
        error: error instanceof Error ? error.message : '获取球队数据失败',
        loading: false 
      });
    }
  },
  ...
  fetchLiveScores: async () => {
    ...
    try {
      ...
      set({ 
        error: error instanceof Error ? error.message : '获取实时比分失败',
        loading: false 
      });
    }
  },
